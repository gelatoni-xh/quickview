...
import GameDetailModal from './2kGames/GameDetailModal'
import GameEditorModal from './2kGames/GameEditorModal'
import ResultTab from './2kGames/ResultTab'
import StatsTab from './2kGames/StatsTab'
